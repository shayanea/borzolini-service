...
export class EmailService implements OnModuleInit {
   ...
   */
  async sendAppointmentReminder(email: string, appointmentData: Record<string, unknown>): Promise<EmailResult> {
    const htmlBody = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
   ...
   */
  async sendHealthAlert(email: string, alertData: Record<string, unknown>): Promise<EmailResult> {
    const htmlBody = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
