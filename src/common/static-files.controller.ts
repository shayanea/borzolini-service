...
export class StaticFilesController {
  ...
  async serveFile(@Param('category') category: string, @Param('subcategory') subcategory: string, @Param('filename') filename: string, @Res() res: Response): Promise<void> {
    try {
  ...
  @ApiResponse({ status: 200, description: 'File served successfully' })
  @ApiResponse({ status: 404, description: 'File not found' })
  async serveFileNoSubcategory(@Param('category') category: string, @Param('filename') filename: string, @Res() res: Response): Promise<void> {
    try {
