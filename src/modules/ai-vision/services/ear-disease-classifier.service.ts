...
import { getEarDiseasePrototypesForBreed } from '../constants/ear-disease-prototypes';

@Injectable()
export class EarDiseaseClassifierService extends BaseBodyPartClassifierService {
  ...
  classify(
    ...
    const prototypes = getEarDiseasePrototypesForBreed(breed);
