...
import { getEyeDiseasePrototypesForBreed } from '../constants/eye-disease-prototypes';

@Injectable()
export class EyeDiseaseClassifierService extends BaseBodyPartClassifierService {
  ...
  classify(
    ...
    const prototypes = getEyeDiseasePrototypesForBreed(breed);
