...
import { IsEnum, IsOptional, IsString, IsUUID, IsArray, IsBoolean } from 'class-validator';
import { InsightCategory, InsightType } from '../entities/ai-health-insight.entity';
